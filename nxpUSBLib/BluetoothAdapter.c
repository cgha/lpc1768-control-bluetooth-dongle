...
static BT_StackConfig_t BluetoothAdapter_Stack =
	{
		.Config = 
			{
				.Class              = (DEVICE_CLASS_SERVICE_AUDIO | DEVICE_CLASS_MAJOR_PERIPHERAL | DEVICE_CLASS_MINOR_PERIPHERAL_GAMEPAD),
				.Name               = "Moga",
				.PINCode            = "0000",
				.Discoverable       = true,
				#ifdef BLUETOOTH_SSP
...
uint8_t BluetoothAdapter_LastLocalBDADDR[6] ;

/** Bluetooth BDADDR of a device to connect to on demand, stored in EEPROM */
uint8_t BluetoothAdapter_RemoteBDADDR[6] ;
