#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\Endpoint_LPC.c"
/*
...
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\../USBMode.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
uint8_t usb_data_buffer[512]  @ "USB_DMA_RAM"; /* TODO 11uxx require buffer is 64 byte aligned */

volatile int32_t usb_data_buffer_size = 0;
volatile uint32_t usb_data_buffer_index = 0;

uint8_t usb_data_buffer_OUT[512]  @ "USB_DMA_RAM"; /* TODO 11uxx require buffer is 64 byte aligned */

volatile uint32_t usb_data_buffer_OUT_size = 0;
volatile uint32_t usb_data_buffer_OUT_index = 0;

uint8_t usb_data_buffer_IN[512]  @ "USB_DMA_RAM"; /* TODO 11uxx require buffer is 64 byte aligned */

//volatile uint32_t usb_data_buffer_IN_size = 0;
volatile uint32_t usb_data_buffer_IN_index = 0;

uint8_t endpointselected;
uint8_t endpointhandle[6];
...
{
#line 71 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\Endpoint_LPC.c"
	for (uint8_t EPNum = Number; EPNum < 6; EPNum++)
	{
//		uint8_t UECFG0XTemp;
//		uint8_t UECFG1XTemp;
//		uint8_t UEIENXTemp;
