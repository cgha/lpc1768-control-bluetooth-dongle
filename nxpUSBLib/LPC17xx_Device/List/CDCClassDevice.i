#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Class\\Device\\CDCClassDevice.c"
/*
 ...
 */
	...
	/* Includes: */
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Class\\Common\\CDCClassCommon.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
_Pragma("weak EVENT_CDC_Device_LineEncodingChanged=CDC_Device_Event_Stub")				
				void EVENT_CDC_Device_LineEncodingChanged(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo)
				                                            ;
_Pragma("weak EVENT_CDC_Device_ControLineStateChanged=CDC_Device_Event_Stub")				
				void EVENT_CDC_Device_ControLineStateChanged(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo)
				                                               ;
_Pragma("weak EVENT_CDC_Device_BreakSent=CDC_Device_Event_Stub2")				
				void EVENT_CDC_Device_BreakSent(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo,
				                                const uint8_t Duration)  
				                                ;
                              ...
                              const char* const String)
{
	...
	Endpoint_Write_Stream_LE(String, strlen(String), 0);
	Endpoint_ClearIN();
                            ...
                            const uint16_t Length)
{
	...
	Endpoint_SelectEndpoint(CDCInterfaceInfo->Config.DataINEndpointNumber);
	Endpoint_Write_Stream_LE(Buffer, Length, 0);
	Endpoint_ClearIN();
	return ENDPOINT_RWSTREAM_NoError;
}
...
uint8_t CDC_Device_Flush(USB_ClassInfo_CDC_Device_t* const CDCInterfaceInfo)
{
	...
	_Bool BankFull = !(Endpoint_IsReadWriteAllowed());
