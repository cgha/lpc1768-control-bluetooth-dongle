#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\DeviceStandardReq.c"
/*
...
_Bool    USB_Device_CurrentlySelfPowered;



_Bool    USB_Device_RemoteWakeupEnabled;
...
static void USB_Device_GetStatus(void)
{
	...
	switch (USB_ControlRequest.bmRequestType)
	{
		...
		case ((1 << 7) | (0 << 5) | (2 << 0)):
			Endpoint_SelectEndpoint((uint8_t)USB_ControlRequest.wIndex & 0x0F);
