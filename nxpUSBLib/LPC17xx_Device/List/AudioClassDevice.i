#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Class\\Device\\AudioClassDevice.c"
/*
 ...
 */
	...
	/* Includes: */
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Class\\Common\\AudioClassCommon.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
_Pragma("weak EVENT_Audio_Device_StreamStartStop=Audio_Device_Event_Stub")				
				void EVENT_Audio_Device_StreamStartStop(USB_ClassInfo_Audio_Device_t* const AudioInterfaceInfo)
				                                          ;
...
void Audio_Device_ProcessControlRequest(USB_ClassInfo_Audio_Device_t* const AudioInterfaceInfo)
{
	...
	if ((USB_ControlRequest.bmRequestType & 0x1F) == (1 << 0))
	{
		if (USB_ControlRequest.wIndex != AudioInterfaceInfo->Config.StreamingInterfaceNumber)
		  return;
	}
	else if ((USB_ControlRequest.bmRequestType & 0x1F) == (2 << 0))
	{
		_Bool EndpointFilterMatch = 0;
	
		EndpointFilterMatch |= (AudioInterfaceInfo->Config.DataINEndpointNumber &&
		                        ((uint8_t)USB_ControlRequest.wIndex == (0x80  | AudioInterfaceInfo->Config.DataINEndpointNumber)));
	
		EndpointFilterMatch |= (AudioInterfaceInfo->Config.DataOUTEndpointNumber &&
		                        ((uint8_t)USB_ControlRequest.wIndex == (0x00 | AudioInterfaceInfo->Config.DataOUTEndpointNumber)));
	...
	switch (USB_ControlRequest.bRequest)
	{
		case REQ_SetInterface:
			if (USB_ControlRequest.bmRequestType == ((0 << 7) | (0 << 5) | (1 << 0)))
			{
				Endpoint_ClearSETUP();
		...
		case AUDIO_REQ_GetStatus:
			if ((USB_ControlRequest.bmRequestType == ((0 << 7) | (1 << 5) | (1 << 0))) ||
			    (USB_ControlRequest.bmRequestType == ((0 << 7) | (1 << 5) | (2 << 0))))
			{
				Endpoint_ClearSETUP();
				Endpoint_ClearStatusStage();
			}
		...
		case AUDIO_REQ_SetResolution:
			if (USB_ControlRequest.bmRequestType == ((0 << 7) | (1 << 5) | (2 << 0)))
			{
		...
		case AUDIO_REQ_GetResolution:
			if (USB_ControlRequest.bmRequestType == ((1 << 7) | (1 << 5) | (2 << 0)))
			{
				uint8_t  EndpointProperty = USB_ControlRequest.bRequest;
				uint8_t  EndpointAddress  = (uint8_t)USB_ControlRequest.wIndex;
				uint8_t  EndpointControl  = (USB_ControlRequest.wValue >> 8);
