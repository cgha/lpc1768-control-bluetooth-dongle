#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\DCD\\LPC17XX\\Endpoint_LPC17xx.c"
/*
...
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\DCD\\LPC17XX\\../../../USBMode.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\DCD\\LPC17XX\\../../../Endpoint.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
volatile _Bool SETUPReceived;
_Bool isOutReceived;
_Bool isInReady;

_Pragma("data_alignment=128")
uint32_t UDCA[32] @ "USB_DMA_RAM" ;
DMADescriptor dmaDescriptor[(6*2)] @ "USB_DMA_RAM";
static uint8_t SetupPackage[8] @ "USB_DMA_RAM";
uint32_t DataInRemainCount,DataInRemainOffset;
_Bool IsConfigured,shortpacket;
uint8_t* ISO_Address;
_Pragma("data_alignment=4")
uint8_t iso_buffer[512]  @ "USB_DMA_RAM";
_Pragma("weak CALLBACK_HAL_GetISOBufferAddress=Dummy_EPGetISOAddress")
uint32_t CALLBACK_HAL_GetISOBufferAddress(const uint32_t EPNum,uint32_t* last_packet_size)  ;
uint32_t BufferAddressIso[32] @ "USB_DMA_RAM";
...
void HAL_Reset (void)
{
	...
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBMaxPSize = 64;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpInd = 1;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBMaxPSize = 64;
	while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000100) == 0);

	/* Slave Register */
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntEn		= 0;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntEn	= (0x00000008 | 0x00000004 | 0x00000200);

	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntClr	= 0xFFFFFFFF;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr	= 0xFFFFFFFF;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntPri	= 0;

	/* DMA registers */
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpDMADis	= 0xFFFFFFFF;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDMARClr		= 0xFFFFFFFF;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEoTIntClr	= 0xFFFFFFFF;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBNDDRIntClr	= 0xFFFFFFFF;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBSysErrIntClr = 0xFFFFFFFF;

	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDMAIntEn  = (0x01 | 0x02 | 0x04 );
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBUDCAH   = (uint32_t) UDCA;
	for (n = 0; n < (6*2); n++) {
		UDCA[n] = 0;
	}
	IsConfigured = 0;
...
{
	if(endpointselected==0)
		SIE_WriteCommandData( (0x00400500 | ((endpointhandle[endpointselected]) << 16)), (0x00000100 | ((0x80) << 16)) );
	else
		SIE_WriteCommandData( (0x00400500 | ((endpointhandle[endpointselected]) << 16)), (0x00000100 | ((0x01) << 16)) );
}
 ...
 * @return
 *********************************************************************/
_Bool Endpoint_ConfigureEndpoint(const uint8_t Number, const uint8_t Type,
								const uint8_t Direction, const uint16_t Size, const uint8_t Banks)
{
	uint32_t PhyEP = 2*Number + (Direction == 0x00 ? 0 : 1);

	if((!IsConfigured)&&(PhyEP>1))
	{
		IsConfigured = 1;
		SIE_WriteCommandData(0x00D80500, (0x00000100 | ((0x01) << 16)));
	}

	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBReEp |= (1 << PhyEP); 		/* Realize endpoint */

	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpInd = PhyEP;				/* Endpoint Index */
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBMaxPSize = Size & 0x3ff;	/* Max Packet Size */

	while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000100) == 0);		/* TODO shouldd we wait for this */
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = 0x00000100;
	
	if (Number == 0) /* Control endpoints have to uses slave mode */
	{
		((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntEn |= (1<<PhyEP);
		DataInRemainCount = 0;
		DataInRemainOffset = 0;
	}else /* all other endpoints use DMA mode */
	{
		memset(&dmaDescriptor[PhyEP], 0, sizeof(DMADescriptor));
		dmaDescriptor[PhyEP].Isochronous = (Type == 0x01 ? 1 : 0 );
		dmaDescriptor[PhyEP].MaxPacketSize = Size;
		dmaDescriptor[PhyEP].Retired = 1; /* inactive DD */
		
		((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpDMAEn = (1<<PhyEP);
	}
	
	SIE_WriteCommandData((0x00400500 | ((PhyEP) << 16)), (0x00000100 | ((0) << 16))); /*enable endpoint*/
	SIE_WriteCommandData((0x00400500 | ((PhyEP) << 16)), (0x00000100 | ((0) << 16))); /* Reset Endpoint */

	endpointhandle[Number] = (Number==0) ? 0 : PhyEP;
	return 1;
}
/********************************************************************//**
 * @brief
...
void ReadControlEndpoint( uint8_t *pData )
{
	...
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCtrl = 0x00000001;
	...
	for (n = 0; n < (cnt + 3) / 4; n++)
	{
		*((uint32_t *)pData) = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBRxData;
		pData += 4;
	}
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCtrl = 0;

	if(cnt >0 && (SETUPReceived == 0))
	{
		isOutReceived = 1;
	}
...
void WriteControlEndpoint( uint8_t *pData, uint32_t cnt )
{
	...
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCtrl = 0x00000002;
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBTxPLen = count;

	for (n = 0; n < (count + 3) / 4; n++)
	{
		((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBTxData = *((uint32_t *)pData);
		pData += 4;
	}

	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCtrl = 0;

	SIE_WriteCommamd((0x00000500 | ((0+1) << 16)));
	SIE_WriteCommamd(0x00FA0500);
}
...
void HAL17XX_USBConnect (uint32_t con)
{
	SIE_WriteCommandData(0x00FE0500, (0x00000100 | ((con ? 0x01 : 0) << 16)));
}
...
void SlaveEndpointISR() 
{
	...
	{
		if (((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntSt & (1<<PhyEP))
		{
			((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEpIntClr = (1<<PhyEP);	/*-- Clear Interrupt Endpoint --*/

			if (PhyEP == 0)            /* Control OUT Endpoint */
			{
				uint32_t SIEEndpointStatus;
				
				while ((((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & 0x00000020) == 0);
				SIEEndpointStatus = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBCmdData;
				
				if (SIEEndpointStatus & 0x04)     /* Setup Packet */
				{
					SETUPReceived = 1;
...
{
	uint32_t PhyEP;
	uint32_t EoTIntSt = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEoTIntSt;

	for (PhyEP = 2; PhyEP < (6*2); PhyEP++)              /* Check All Endpoints */
	{
		if ( EoTIntSt & (1<<PhyEP) )
		{
			if ( (! ((PhyEP) & 1) ) )                 /* OUT Endpoint */
			{
				if(dmaDescriptor[PhyEP].Isochronous == 1) // iso endpoint
				{
	...
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBEoTIntClr = EoTIntSt;
}

void DMANewTransferRequestISR() 
{
	uint32_t PhyEP;
	uint32_t NDDRIntSt = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBNDDRIntSt;

	for (PhyEP = 2; PhyEP < (6*2); PhyEP++)              /* Check All Endpoints */
	{
		if ( NDDRIntSt & (1<<PhyEP) )
		{
			if ( (! ((PhyEP) & 1) ) )                     /* OUT Endpoint */
			{
				if(dmaDescriptor[PhyEP].Isochronous == 1) // iso endpoint
	...
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBNDDRIntClr = NDDRIntSt;
}
...
void DcdIrqHandler (uint8_t DeviceID)
{
	...
	DevIntSt = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntSt & ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntEn;                      /* Device Interrupt Status */
	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDevIntClr = DevIntSt;

	/* Device Status Interrupt (Reset, Connect change, Suspend/Resume) */
	if (DevIntSt & 0x00000008)
	{
		uint32_t SIEDeviceStatus;
		SIE_WriteCommamd(0x00FE0500);
		SIEDeviceStatus = SIE_ReadCommandData(0x00FE0200);       /* Device Status */
		if (SIEDeviceStatus & 0x10)	                    /* Reset */
		{
			HAL_Reset();
			USB_DeviceState = DEVICE_STATE_Default;
			Endpoint_ConfigureEndpoint(0, 0, 0x00, 64,0);
			Endpoint_ConfigureEndpoint(0, 0, 0x80, 64,0);
		}
		if (SIEDeviceStatus & 0x02)	                /* Connect change */
		{
		}
		if (SIEDeviceStatus & 0x08)                   /* Suspend/Resume */
		{
			if (SIEDeviceStatus & 0x04)                  /* Suspend */
			{
			}
			else                                /* Resume */
			{
	...
	if (DevIntSt & 0x00000001)
	{

	}

	if (DevIntSt & 0x00000200)
	{
		volatile uint32_t SIEErrorStatus;
		SIE_WriteCommamd(0x00FB0500);
		SIEErrorStatus = SIE_ReadCommandData(0x00FB0200);
	}

	/* SLAVE mode : Endpoint's Slow Interrupt */
	if ( (DevIntSt & 0x00000004) || (DevIntSt & 0x00000002) )
	{
		SlaveEndpointISR();
	}

	/* DMA mode */
	DMAIntSt = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDMAIntSt & ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBDMAIntEn;
	
	if (DMAIntSt & 0x01)            /* End of Transfer Interrupt */
	{
		DMAEndTransferISR();

	}

	if (DMAIntSt & 0x02)            /* New DD Request Interrupt */
	{
		DMANewTransferRequestISR();

	}

	if (DMAIntSt & 0x04)            /* System Error Interrupt */
	{
		// DMASysErrISR();
		((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBSysErrIntClr = ((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBSysErrIntSt;
	}
}
