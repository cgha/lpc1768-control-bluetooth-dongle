#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\USBController_LPC.c"
/*
...
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\DeviceStandardReq.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
void USB_ResetInterface(void)
{
	if (USB_MODE_Device == USB_MODE_Device)
	{

		USB_Init_Device();

	}
	else if (USB_MODE_Device == USB_MODE_Host)
	{
...
static void USB_Init_Device(void)
{
	...
	USB_Device_RemoteWakeupEnabled  = 0;



	USB_Device_CurrentlySelfPowered = 0;
