#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\EndpointStream_LPC.c"
/*
 ...
 */ 
	...
	/* Includes: */
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\../../../../Common/Common.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
uint8_t Endpoint_Write_Control_Stream_LE(const void* const Buffer,
			                                         uint16_t Length)
{
	Endpoint_Write_Stream_LE((uint8_t*)Buffer, (((Length) < (USB_ControlRequest . wLength)) ? (Length) : (USB_ControlRequest . wLength)), 0);
	Endpoint_ClearIN();
			                                        ...
			                                        uint16_t Length)
{
	...
	Endpoint_Read_Stream_LE(Buffer,Length,0);	//but hangs LPC17xx --> comment out
	Endpoint_ClearOUT();
	return ENDPOINT_RWCSTREAM_NoError;
}
