#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Class\\Device\\MIDIClassDevice.c"
/*
                                    ...
                                    const MIDI_EventPacket_t* const Event)
{
	...
	if ((ErrorCode = Endpoint_Write_Stream_LE(Event, sizeof(MIDI_EventPacket_t), 0)) != ENDPOINT_RWSTREAM_NoError)
	  return ErrorCode;
                                    ...
                                    MIDI_EventPacket_t* const Event)
{
	...
	Endpoint_Read_Stream_LE(Event, sizeof(MIDI_EventPacket_t), 0);
