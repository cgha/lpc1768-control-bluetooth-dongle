#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Class\\Device\\RNDISClassDevice.c"
/*
	...
	/* Private Interface - For use in library only: */
		...
		/* Function Prototypes: */
			...
			static void RNDIS_Device_ProcessRNDISControlMessage(USB_ClassInfo_RNDIS_Device_t* const RNDISInterfaceInfo)
			                                                    ;
			static _Bool RNDIS_Device_ProcessNDISQuery(USB_ClassInfo_RNDIS_Device_t* const RNDISInterfaceInfo,
			                                          const uint32_t OId,
                                                      ...
                                                      uint16_t* const ResponseSize) 
			                                           ;
			static _Bool RNDIS_Device_ProcessNDISSet(USB_ClassInfo_RNDIS_Device_t* const RNDISInterfaceInfo,
                                                    const uint32_t OId,
			                                        const void* SetData,
...
_Bool RNDIS_Device_ConfigureEndpoints(USB_ClassInfo_RNDIS_Device_t* const RNDISInterfaceInfo)
{
	...
	for (uint8_t EndpointNum = 1; EndpointNum < 6; EndpointNum++)
	{
		uint16_t Size;
		uint8_t  Type;
		uint8_t  Direction;
...
void RNDIS_Device_USBTask(USB_ClassInfo_RNDIS_Device_t* const RNDISInterfaceInfo)
{
	...
	if (Endpoint_IsINReady() && RNDISInterfaceInfo->State.ResponseReady)
	{
		...
		Endpoint_Write_Stream_LE(&Notification, sizeof(USB_Request_Header_t), 0);

		Endpoint_ClearIN();

		RNDISInterfaceInfo->State.ResponseReady = 0;
	}
}
...
void RNDIS_Device_ProcessRNDISControlMessage(USB_ClassInfo_RNDIS_Device_t* const RNDISInterfaceInfo)
{
	...
	{
		case 0x00000002UL:
			RNDISInterfaceInfo->State.ResponseReady     = 1;
			...
			INITIALIZE_Response->MessageType            = (0x80000002UL);
			INITIALIZE_Response->MessageLength          = (sizeof(RNDIS_Initialize_Complete_t));
			INITIALIZE_Response->RequestId              = INITIALIZE_Message->RequestId;
			INITIALIZE_Response->Status                 = (0x00000000UL);

			INITIALIZE_Response->MajorVersion           = (0x01);
			INITIALIZE_Response->MinorVersion           = (0x00);
			INITIALIZE_Response->DeviceFlags            = (0x00000001UL);
			INITIALIZE_Response->Medium                 = (0x00000000UL);
			INITIALIZE_Response->MaxPacketsPerTransfer  = (1);
			INITIALIZE_Response->MaxTransferSize        = (sizeof(RNDIS_Packet_Message_t) + 1500);
		...
		case 0x00000004UL:
			...
			{
				QUERY_Response->Status                  = (0xC00000BBUL);
		...
		case 0x00000005UL:
			...
			SET_Response->MessageType                   = (0x80000005UL);
		...
		case 0x00000006UL:
			...
			RESET_Response->MessageType                 = (0x80000006UL);
			RESET_Response->MessageLength               = (sizeof(RNDIS_Reset_Complete_t));
			RESET_Response->Status                      = (0x00000000UL);
		...
		case 0x00000008UL:
			...
			KEEPALIVE_Response->MessageType             = (0x80000008UL);
			KEEPALIVE_Response->MessageLength           = (sizeof(RNDIS_KeepAlive_Complete_t));
			KEEPALIVE_Response->RequestId               = KEEPALIVE_Message->RequestId;
			KEEPALIVE_Response->Status                  = (0x00000000UL);
                                          ...
                                          uint16_t* const ResponseSize)
{
	...
	switch (OId)
	{
		...
		case 0x00010104UL:
			...
			*((uint32_t*)ResponseData) = (0x00000000UL);
		...
		case 0x00010111UL:
			...
			*((uint32_t*)ResponseData) = (128 + 1500);
                                        ...
                                        const uint16_t SetSize)
{
	...
	switch (OId)
	{
		case 0x0001010EUL:
			...
			RNDISInterfaceInfo->State.CurrRNDISState   = ((RNDISInterfaceInfo->State . CurrPacketFilter) ? RNDIS_Data_Initialized : RNDIS_Data_Initialized);
                                ...
                                uint16_t* const PacketLength)
{
	...
	*PacketLength = 0;
	...
	Endpoint_Read_Stream_LE(&RNDISPacketHeader, sizeof(RNDIS_Packet_Message_t), 0);

	if ((RNDISPacketHeader . DataLength) > 1500)
	{
	...
	*PacketLength = (uint16_t)(RNDISPacketHeader . DataLength);
	...
	Endpoint_Read_Stream_LE(Buffer, *PacketLength, 0);
	Endpoint_ClearOUT();
                                ...
                                const uint16_t PacketLength)
{
	...
	RNDISPacketHeader.MessageType   = (0x00000001UL);
	...
	Endpoint_Write_Stream_LE(&RNDISPacketHeader, sizeof(RNDIS_Packet_Message_t), 0);
	Endpoint_Write_Stream_LE(Buffer, PacketLength, 0);
	Endpoint_ClearIN();
