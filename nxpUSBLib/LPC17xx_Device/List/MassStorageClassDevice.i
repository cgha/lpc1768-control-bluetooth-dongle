#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Class\\Device\\MassStorageClassDevice.c"
/*
...
#line 62 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Class\\Device\\MassStorageClassDevice.h"
	...
	/* Private Interface - For use in library only: */
		...
		/* Function Prototypes: */
				...
				static _Bool MS_Device_ReadInCommandBlock(USB_ClassInfo_MS_Device_t* const MSInterfaceInfo) ;
	...
	switch (USB_ControlRequest.bRequest)
	{
		case MS_REQ_MassStorageReset:
			if (USB_ControlRequest.bmRequestType == ((0 << 7) | (1 << 5) | (1 << 0)))
			{
				...
				MSInterfaceInfo->State.IsMassStoreReset = 1;
			}
...
void MS_Device_USBTask(USB_ClassInfo_MS_Device_t* const MSInterfaceInfo)
{
	...
	if (Endpoint_IsReadWriteAllowed())
	{
		...
		{
			if (MSInterfaceInfo->State.CommandBlock.Flags & (1 << 7))
			  Endpoint_SelectEndpoint(MSInterfaceInfo->Config.DataINEndpointNumber);

			_Bool SCSICommandResult = CALLBACK_MS_Device_SCSICommandReceived(MSInterfaceInfo);

			MSInterfaceInfo->State.CommandStatus.Status              = (SCSICommandResult) ? MS_SCSI_COMMAND_Pass : MS_SCSI_COMMAND_Fail;
			MSInterfaceInfo->State.CommandStatus.Signature           = (0x53425355UL);
			MSInterfaceInfo->State.CommandStatus.Tag                 = MSInterfaceInfo->State.CommandBlock.Tag;
			MSInterfaceInfo->State.CommandStatus.DataTransferResidue = MSInterfaceInfo->State.CommandBlock.DataTransferLength;

			if (!(SCSICommandResult) && ((MSInterfaceInfo->State . CommandStatus . DataTransferResidue)))
	...
	if (MSInterfaceInfo->State.IsMassStoreReset)
	{
		...
		MSInterfaceInfo->State.IsMassStoreReset = 0;
	}
}
...
static _Bool MS_Device_ReadInCommandBlock(USB_ClassInfo_MS_Device_t* const MSInterfaceInfo)
{
	...
	if ((MSInterfaceInfo->State.CommandBlock.Signature         != (0x43425355UL))     ||
