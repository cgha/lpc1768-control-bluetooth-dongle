#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\HAL\\LPC17XX\\HAL_LPC17xx.c"
/*
...
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\HAL\\LPC17XX\\../HAL_LPC.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
/* --------------------------------- End Of File ------------------------------ */
#line 37 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\HAL\\LPC17XX/HAL_LPC17xx.h"
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\HAL\\LPC17XX\\../../../USBMode.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
...
/* --------------------------------- End Of File ------------------------------ */
#line 30 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\HAL\\LPC17XX\\HAL_LPC17xx.c"
#line 1 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\HAL\\LPC17XX\\../../../USBTask.h"
/*
* Copyright(C) NXP Semiconductors, 2011
* All rights reserved.
*
 ...
 *********************************************************************/
 void HAL_USBInit(void)
 {
  	...
  	((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 &= ~((3<<26)|(3<<28));  /* P0.29 D+, P0.30 D- */
  	((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 |=  ((1<<26)|(1<<28));  /* PINSEL1 26.27, 28.29  = 01 */

#line 49 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\HAL\\LPC17XX\\HAL_LPC17xx.c"

#line 66 "J:\\code\\nxpUSBlib v0.97\\libraries\\nxpUSBLib\\Drivers\\USB\\Core\\LPC\\HAL\\LPC17XX\\HAL_LPC17xx.c"

  	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP |= (1UL<<31);                	/* USB PCLK -> enable USB Per.*/


	((LPC_USB_TypeDef *) ((0x50000000UL) + 0x0C000) )->USBClkCtrl = 0x12;                 /* Dev, PortSel, AHB clock enable */
 ...
 *********************************************************************/
 void HAL_USBDeInit(void)
 {
 	...
 	((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCONP &= (~(1UL<<31));              /* disable USB Per.      */

 	((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL1 &= ~((3<<26)|(3<<28));  /* P0.29 D+, P0.30 D- reset to GPIO function */
