 ...
 */
BT_L2CAP_Channel_t* Bluetooth_L2CAP_FindChannel(BT_StackConfig_t* const StackState,
                                                      const uint16_t ConnectionHandle,
...
static BT_L2CAP_Channel_t* Bluetooth_L2CAP_NewChannel(BT_StackConfig_t* const StackState,
                                                            const uint16_t ConnectionHandle,
                                                            const uint16_t RemoteChannel,
                                                            const uint16_t PSM)
{
                                             ...
                                             void* Data)
{
	...
	len = sizeof(BT_Signal_Header_t)+Length; 
	//return Bluetooth_L2CAP_SendPacket(StackState, &SignalChannel, sizeof(SignalPacket), &SignalPacket);
	ret = Bluetooth_L2CAP_SendPacket(StackState, &SignalChannel, len, &SignalPacket);
	return ret;
}
 ...
 */
BT_L2CAP_Channel_t* Bluetooth_L2CAP_OpenChannel(BT_StackConfig_t* const StackState,
                                                      BT_HCI_Connection_t* const HCIConnection,
                                                      const uint16_t PSM)
{	  
                                ...
                                const void* Data)
{
	...
	struct
	{
		...
		uint8_t                Data[512]; //should notice that the BT_DataPacket_Header_t is packed
	...
	uint16_t length = sizeof(BT_DataPacket_Header_t)+BytesInPacket;
	if (!(Bluetooth_HCI_SendPacket(StackState, HCIConnection, false, length, &FirstPacket)))
	  return false;
