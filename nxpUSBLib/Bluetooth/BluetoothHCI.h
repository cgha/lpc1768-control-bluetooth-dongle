...
#define _BLUETOOTH_HCI_H_
	...
	/* Enums: */
		...
		enum BT_HCIStates_t
		{
			...
			HCISTATE_Init_SetEventMask			  = 1,
			HCISTATE_Init_ReadBufferSize          = 2, /**< The HCI layer is currently retrieving the buffer size of the Bluetooth adapter. */
			HCISTATE_Init_GetBDADDR               = 3, /**< The HCI layer is currently retrieving the local BDADDR the Bluetooth adapter. */
			HCISTATE_Init_SetSSP				  = 4,
			HCISTATE_Init_WriteAuthEnable		  = 5,
			HCISTATE_Init_SetLocalName            = 9, /**< The HCI layer is currently setting the local name of the Bluetooth adapter. */
			HCISTATE_Init_SetDeviceClass          = 10, /**< The HCI layer is currently setting the local device class of the Bluetooth adapter. */
			HCISTATE_Init_SetScanEnable           = 11, /**< The HCI layer is currently setting the scan mode of the Bluetooth adapter. */
			HCISTATE_Idle                         = 12, /**< The HCI layer is ready to accept and send data. */
		};
