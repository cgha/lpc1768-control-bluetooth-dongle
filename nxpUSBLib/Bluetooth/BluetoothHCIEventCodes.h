...
#define _BLUETOOTH_HCIEVENT_CODES_H_
	...
	/* Macros: */
		...
		#define OCF_LINK_CTNTROL_IO_CAPABILITY_REQUEST_REPLY   0x002B
		#define OCF_LINK_CONTROL_USER_CONFIRM_REQUEST_REPLY    0x002C
		#define OCF_LINK_CTNTROL_IO_CAPABILITY_REQUEST_NEGATIVE_REPLY   0x0034
		//@}
		...
		#define HCI_ERROR_SECURITY_MODE_NOT_ACCEPTABLE		   0x25
		//@}
