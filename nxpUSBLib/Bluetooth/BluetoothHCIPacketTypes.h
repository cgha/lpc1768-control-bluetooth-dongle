...
#pragma pack(1)
	/* Type Defines: */
		...
		typedef struct
		{
			uint8_t RemoteBDADDR[6]; /**< Bluetooth BDADDR of the remote device. */
		...
		typedef struct
		{
			uint8_t RemoteBDADDR[6];
			uint8_t LinkKey[16];
		} ATTR_PACKED BT_HCICommand_LinkKeyACKResp_t;
		...
		{
			uint8_t  RemoteBDADDR[6];
		} ATTR_PACKED BT_HCIEvent_IOCabilityReq_t;
		
		typedef struct
		{
			uint8_t  RemoteBDADDR[6];
			uint8_t	 IO_Capability;
			uint8_t  OOB_DataPresent;
			uint8_t  AuthenticationRequirements;				
		} ATTR_PACKED BT_HCICommand_IOCapbilityAckResp_t;

		typedef struct
		{
			uint8_t  RemoteBDADDR[6];
			uint8_t	 Reason;				
		} ATTR_PACKED BT_HCICommand_IOCapbilityNakResp_t;
		...
		typedef struct
		{
			...
			uint8_t  OOB_DataPresent;
			uint8_t  AuthenticationRequirements;	
		} ATTR_PACKED BT_HCICommand_IOCapbilityRsp_t;

		typedef struct
		{
			uint8_t  RemoteBDADDR[6];
			uint8_t  NumericValue[4];
		} ATTR_PACKED BT_HCIEvent_UserConfirmReq_t;

		typedef struct
		{
			uint8_t  RemoteBDADDR[6];
		} ATTR_PACKED BT_HCIEvent_UserConfirmReqAck_t;

		typedef struct
		{
			uint8_t   status;
			uint8_t   RemoteBDADDR[6];
		} ATTR_PACKED BT_HCIEvent_SimplePairingComplete_t;
		...
		typedef struct
		{
			...
			uint8_t  LinkKey[16];
			uint8_t  KeyType;
		} ATTR_PACKED BT_HCIEvent_LinkKeyNotification_t;
		typedef struct
		{
			uint8_t  status;
			uint16_t conn_handle;
			uint8_t  encryption_enable;
		} ATTR_PACKED BT_HCIEvent_EncryptionChange_t;
#endif		
#pragma pack(pop)		
#endif
